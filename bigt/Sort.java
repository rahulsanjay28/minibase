...
public class Sort extends Iterator implements GlobalConst {
        ...
        private iterator.pnodeSplayPQ Q;
        ...
        private boolean useBM = true; // flag for whether to use buffer managerpublic Map    get_next
        ...
        @Override
        public Map get_next() throws IOException, JoinsException, IndexException, InvalidTupleSizeException, InvalidTypeException, PageNotReadException, TupleUtilsException, PredEvalException, SortException, LowMemException, UnknowAttrType, UnknownKeyTypeException, Exception {
                if (first_time) {
        ...
        private Map delete_min()
                ...
                SortException,
                Exception {
                bigt.pnode cur_node;                // needs pq_defs.java
                Map new_map, old_map;

                cur_node = (bigt.pnode)Q.deq();
	...
	*/
        ...
        private int generate_runs(int max_elems, AttrType sortFldType, int sortFldLen)
                ...
                while (true) {
                        cur_node = (bigt.pnode)pcurr_Q.deq();
         ...
         *
         * @param map_size size (in bytes) of each tuple
